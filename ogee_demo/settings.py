"""
Django settings for ogee_demo project.
"""
...
DATATYPE_LOCATIONS.append("ogee_demo.datatypes")
FUNCTION_LOCATIONS.append("ogee_demo.functions")
ETL_MODULE_LOCATIONS.append("ogee_demo.etl_modules")
SEARCH_COMPONENT_LOCATIONS.append("ogee_demo.search_components")
...
SECRET_KEY = "django-insecure-hr3%%z0j56(erz*czxj@i%c0m%*j47z-*k!ds4t@duqb_6jiyb"

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ROOT_URLCONF = "ogee_demo.urls"
ROOT_HOSTCONF = "ogee_demo.hosts"

DEFAULT_HOST = "ogee_demo"
...
ELASTICSEARCH_PREFIX = "ogee_demo"

ELASTICSEARCH_CUSTOM_INDEXES = []
# [{
#     'module': 'ogee_demo.search_indexes.sample_index.SampleIndex',
...
INSTALLED_APPS = (
    ...
    "pgtrigger",
    # "silk",
    "ogee_demo",  # Ensure the project is listed before any other arches applications
)
...
WSGI_APPLICATION = "ogee_demo.wsgi.application"
...
# ES_MAPPING_MODIFIER_CLASSES = ["ogee_demo.search.es_mapping_modifier.EsMappingModifier"]
